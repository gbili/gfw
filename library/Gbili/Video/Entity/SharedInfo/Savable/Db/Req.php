<?php
namespace Gbili\Video\Entity\SharedInfo\Db;

use Gbili\Db\Req\AbstractReq,
    Gbili\Image\Savable                   as ImageSavable,
    Gbili\Video\Entity\SharedInfo\Savable as SharedInfoSavable;
...
extends AbstractReq
{
	...
	/**
	 * (non-PHPdoc)
	 * @see Db/Buttons/\Gbili\Db\ActiveRecord\ActiveRecordInterface#save()
	 */
	public function save(SharedInfoSavable $vESI)
	{
	...
	/**
	 * 
	 * @param Video_Entity_SharedInfo_Savable $vESI
	 * @return unknown_type
	 */
	public function associateImage(SharedInfoSavable $vESI)
	{
		if (!$vESI->hasImage()) {
			return;
		}
	 ...
	 */
	public function existsSharedInfo(SharedInfoSavable $vESI, $returnIdIfAvailable = false)
	{
	...
	public function delete(SharedInfoSavable $vESI)
	{
